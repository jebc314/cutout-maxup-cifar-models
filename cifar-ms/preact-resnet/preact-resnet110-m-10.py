...
def main():
    ...
    if use_gpu:
        ...
        model = preact_resnet110_cifar(num_classes=100) # 6th-using 100
        ...
        if not os.path.exists('result'):
            os.makedirs('result')
        fdir = 'result/preact-resnet110-m-10' # 6th-saving to right name
    ...
    # CIFAR100
        ...
        train_dataset = torchvision.datasets.CIFAR100(
            ...
            transform=transforms.Compose([
                ...
                transforms.ToTensor(),
                normalize,
                Cutout(n_holes=1, length=8) # 6th-Add cutout transformation
            ]))
        trainloader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=2)
